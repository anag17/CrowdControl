                            ...
                            if (blinkingControlMode == ControlMode.Classic) {
                                ...
                                for (int b = 0; b < blinkingShape.bones.Count; b++) {
                                    if (boneUpdateAnimation) {
                                        ...
                                        if (!blinkingShape.bones[b].lockPosition) blinkingShape.bones[b].bone.localPosition += newPos;
                                        if (!blinkingShape.bones[b].lockRotation) blinkingShape.bones[b].bone.localEulerAngles += newRot;
                                    } else {
                                        if (!blinkingShape.bones[b].lockPosition) blinkingShape.bones[b].bone.localPosition = Vector3.Lerp(boneShapes[blinkingShape.bones[b].bone].storedPosition, blinkingShape.bones[b].endPosition, blinkTimer / halfBlinkSpeed);
                                        if (!blinkingShape.bones[b].lockRotation) blinkingShape.bones[b].bone.localEulerAngles = Vector3.Lerp(boneShapes[blinkingShape.bones[b].bone].storedRotation.eulerAngles, blinkingShape.bones[b].endRotation, blinkTimer / halfBlinkSpeed);
                                    }
                                }
                            }
                        } else {
                            if (blinkingControlMode == ControlMode.Classic) {
                                ...
                                for (int b = 0; b < blinkingShape.bones.Count; b++) {
                                    if (boneUpdateAnimation) {
                                        ...
                                        if (!blinkingShape.bones[b].lockPosition) blinkingShape.bones[b].bone.localPosition = Vector3.Lerp(blinkingShape.bones[b].endPosition, boneShapes[blinkingShape.bones[b].bone].storedPosition, (blinkTimer - halfBlinkSpeed) / halfBlinkSpeed);
                                        if (!blinkingShape.bones[b].lockRotation) blinkingShape.bones[b].bone.localEulerAngles = Vector3.Lerp(blinkingShape.bones[b].endRotation, boneShapes[blinkingShape.bones[b].bone].storedRotation.eulerAngles, (blinkTimer - halfBlinkSpeed) / halfBlinkSpeed);
                                    }
                                }
                            }
                ...
                if (lookingControlMode == ControlMode.Classic) {
                    ...
                    if (randomBlend.y >= 0) {
                        ...
                        for (int b = 0; b < lookingUpShape.bones.Count; b++) {
                            ...
                            if (boneUpdateAnimation) {
                                if (!lookingUpShape.bones[b].lockPosition) boneShapes[lookingUpShape.bones[b].bone].targetPosition = lookingUpShape.bones[b].bone.localPosition + (newPos - lookingUpShape.bones[b].neutralPosition);
                                if (!lookingUpShape.bones[b].lockRotation) boneShapes[lookingUpShape.bones[b].bone].targetRotation = Quaternion.Euler(lookingUpShape.bones[b].bone.localEulerAngles + (newRot - lookingUpShape.bones[b].neutralRotation));
                            } else {
                                if (!lookingUpShape.bones[b].lockPosition) boneShapes[lookingUpShape.bones[b].bone].targetPosition = newPos;
                                if (!lookingUpShape.bones[b].lockRotation) boneShapes[lookingUpShape.bones[b].bone].targetRotation = Quaternion.Euler(newRot);
                            }

                            if (!lookingUpShape.bones[b].lockPosition) boneShapes[lookingUpShape.bones[b].bone].storedPosition = Vector3.Lerp(boneShapes[lookingUpShape.bones[b].bone].storedPosition, boneShapes[lookingUpShape.bones[b].bone].targetPosition, Time.deltaTime * eyeTurnSpeed);
                            if (!lookingUpShape.bones[b].lockRotation) boneShapes[lookingUpShape.bones[b].bone].storedRotation = Quaternion.Lerp(boneShapes[lookingUpShape.bones[b].bone].storedRotation, boneShapes[lookingUpShape.bones[b].bone].targetRotation, Time.deltaTime * eyeTurnSpeed);
                        }
                    } else {
                        // Looking Down Range
                        ...
                        for (int b = 0; b < lookingDownShape.bones.Count; b++) {
                            ...
                            if (boneUpdateAnimation) {
                                if (!lookingDownShape.bones[b].lockPosition) boneShapes[lookingDownShape.bones[b].bone].targetPosition = lookingDownShape.bones[b].bone.localPosition + (newPos - lookingDownShape.bones[b].neutralPosition);
                                if (!lookingDownShape.bones[b].lockRotation) boneShapes[lookingDownShape.bones[b].bone].targetRotation = Quaternion.Euler(lookingDownShape.bones[b].bone.localEulerAngles + (newRot - lookingDownShape.bones[b].neutralRotation));
                            } else {
                                if (!lookingDownShape.bones[b].lockPosition) boneShapes[lookingDownShape.bones[b].bone].targetPosition = newPos;
                                if (!lookingDownShape.bones[b].lockRotation) boneShapes[lookingDownShape.bones[b].bone].targetRotation = Quaternion.Euler(newRot);
                            }

                            if (!lookingDownShape.bones[b].lockPosition) boneShapes[lookingDownShape.bones[b].bone].storedPosition = Vector3.Lerp(boneShapes[lookingDownShape.bones[b].bone].storedPosition, boneShapes[lookingDownShape.bones[b].bone].targetPosition, Time.deltaTime * eyeTurnSpeed);
                            if (!lookingDownShape.bones[b].lockRotation) boneShapes[lookingDownShape.bones[b].bone].storedRotation = Quaternion.Lerp(boneShapes[lookingDownShape.bones[b].bone].storedRotation, boneShapes[lookingDownShape.bones[b].bone].targetRotation, Time.deltaTime * eyeTurnSpeed);
                        }
                    }
                    ...
                    if (randomBlend.x >= 0) {
                        ...
                        for (int b = 0; b < lookingRightShape.bones.Count; b++) {
                            ...
                            if (!lookingRightShape.bones[b].lockPosition) boneShapes[lookingRightShape.bones[b].bone].targetPosition = lookingRightShape.bones[b].bone.localPosition + newPos;
                            if (!lookingRightShape.bones[b].lockRotation) boneShapes[lookingRightShape.bones[b].bone].targetRotation = Quaternion.Euler(lookingRightShape.bones[b].bone.localEulerAngles + newRot);

                            if (!lookingRightShape.bones[b].lockPosition) boneShapes[lookingRightShape.bones[b].bone].storedPosition = Vector3.Lerp(boneShapes[lookingRightShape.bones[b].bone].storedPosition, boneShapes[lookingRightShape.bones[b].bone].targetPosition, Time.deltaTime * eyeTurnSpeed);
                            if (!lookingRightShape.bones[b].lockRotation) boneShapes[lookingRightShape.bones[b].bone].storedRotation = Quaternion.Lerp(boneShapes[lookingRightShape.bones[b].bone].storedRotation, boneShapes[lookingRightShape.bones[b].bone].targetRotation, Time.deltaTime * eyeTurnSpeed);
                        }
                    } else {
                        // Looking Left Range
                        ...
                        for (int b = 0; b < lookingLeftShape.bones.Count; b++) {
                            ...
                            if (!lookingLeftShape.bones[b].lockPosition) boneShapes[lookingLeftShape.bones[b].bone].targetPosition = lookingLeftShape.bones[b].bone.localPosition + newPos;
                            if (!lookingLeftShape.bones[b].lockRotation) boneShapes[lookingLeftShape.bones[b].bone].targetRotation = Quaternion.Euler(lookingLeftShape.bones[b].bone.localEulerAngles + newRot);

                            if (!lookingLeftShape.bones[b].lockPosition) boneShapes[lookingLeftShape.bones[b].bone].storedPosition = Vector3.Lerp(boneShapes[lookingLeftShape.bones[b].bone].storedPosition, boneShapes[lookingLeftShape.bones[b].bone].targetPosition, Time.deltaTime * eyeTurnSpeed);
                            if (!lookingLeftShape.bones[b].lockRotation) boneShapes[lookingLeftShape.bones[b].bone].storedRotation = Quaternion.Lerp(boneShapes[lookingLeftShape.bones[b].bone].storedRotation, boneShapes[lookingLeftShape.bones[b].bone].targetRotation, Time.deltaTime * eyeTurnSpeed);
                        }
                    }
                }
            }
                ...
                if (blinkingControlMode == ControlMode.Classic) {
                    ...
                    for (int b = 0; b < blinkingShape.bones.Count; b++) {
                        if (boneUpdateAnimation) {
                            ...
                            if (!blinkingShape.bones[b].lockPosition) blinkingShape.bones[b].bone.localPosition = Vector3.Lerp(blinkingShape.bones[b].neutralPosition, blinkingShape.bones[b].endPosition, blinkTimer / blinkDuration);
                            if (!blinkingShape.bones[b].lockRotation) blinkingShape.bones[b].bone.localEulerAngles = Vector3.Lerp(blinkingShape.bones[b].neutralRotation, blinkingShape.bones[b].endRotation, blinkTimer / blinkDuration);
                        }
                    }
                }
                ...
                if (blinkingControlMode == ControlMode.Classic) {
                    ...
                    for (int b = 0; b < blinkingShape.bones.Count; b++) {
                        if (boneUpdateAnimation) {
                            ...
                            if (!blinkingShape.bones[b].lockPosition) blinkingShape.bones[b].bone.localPosition = Vector3.Lerp(blinkingShape.bones[b].endPosition, blinkingShape.bones[b].neutralPosition, blinkTimer / blinkDuration);
                            if (!blinkingShape.bones[b].lockRotation) blinkingShape.bones[b].bone.localEulerAngles = Vector3.Lerp(blinkingShape.bones[b].endRotation, blinkingShape.bones[b].neutralRotation, blinkTimer / blinkDuration);
                        }
                    }
                }
